                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center">
                                    <a href="edit_giaovien.php?id=<?= $item['maGV'] ?>"
                                        class="btn btn-info btn-sm editable">
                                        <i class="fas fa-pencil-alt"></i>Sửa
                                    </a>
                                </td>
                                </button>
                                <td style="text-align:center">
                                    <a class="btn btn-danger btn-sm deleteable"
                                        href="process_delete_giaovien.php?id=<?= $item['maGV'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="ngaySinhEdit" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" id="ngaySinh"
                                        name="ngaySinh" data-toggle="datetimepicker" data-target="#ngaySinhEdit">
                                    <div class="input-group-append" data-target="#ngaySinhEdit"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="ngaySinhAdd" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" name="ngaySinh"
                                        data-toggle="datetimepicker" data-target="#ngaySinhAdd">
                                    <div class="input-group-append" data-target="#ngaySinhAdd"
                                        data-toggle="datetimepicker">
                                        <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                </div>
